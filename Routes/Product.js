...
// DELETE request to delete a request by request code


// DELETE request to delete a request by product code and requested email
router.delete('/request/delete/:productCode/:requestedEmail', async (req, res) => {
  try {
    const { productCode, requestedEmail } = req.params;

    // Find and delete the request by product code and requested email
    await Request.deleteMany({ productCode, requestedEmail });
